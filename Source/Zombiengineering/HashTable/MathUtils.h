...
public:
    ...
    static ZOMBIENGINEERING_API double Extensionalize(double Value);

    static ZOMBIENGINEERING_API double ToFloat(int64_t Value);
    ...
    static ZOMBIENGINEERING_API double FloatAdd(double Left, double Right);
    static ZOMBIENGINEERING_API double FloatSubtract(double Left, double Right);
    static ZOMBIENGINEERING_API double FloatMultiply(double Left, double Right);
    static ZOMBIENGINEERING_API double FloatDivide(double Left, double Right);
    ...
    static ZOMBIENGINEERING_API bool FloatIsFinite(double Value);
    static ZOMBIENGINEERING_API bool FloatIsInfinite(double Value);
    static ZOMBIENGINEERING_API bool FloatIsNaN(double Value);
    ...
    static ZOMBIENGINEERING_API bool FloatEqual(double Left, double Right);
    static ZOMBIENGINEERING_API bool FloatLess(double Left, double Right);
    static ZOMBIENGINEERING_API bool FloatLessEqual(double Left, double Right);
    ...
    static ZOMBIENGINEERING_API int64_t FloatRanking(double Value);
};
